...
function GetbyId() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const responseData = await response.json(); // Optionally, you can handle the response data here
      redirect.push('/')// Redirect to the home page after successful update
    } catch (error) {
      console.error(error);
    }
  };
        ...
        <section className="text-gray-600 body-font relative">
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-col text-center w-full mb-12">
              <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">CRUD APPLICATION</h1>
            </div>
            <div className="lg:w-1/2 md:w-2/3 mx-auto">
              <div className="flex flex-wrap -m-2">
                ...
                <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                  <a className="text-indigo-500">faisaldeveloperr@gmail.com</a>
                  <div className="flex flex-row flex-wrap justify-center px-14 pt-3 " >
      <Link href="https://www.linkedin.com/in/muhammad-faisal-224427210/" target="_blank" className="mr-1"> <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="48px" height="48px"><path fill="#0288D1" d="M42,37c0,2.762-2.238,5-5,5H11c-2.761,0-5-2.238-5-5V11c0-2.762,2.239-5,5-5h26c2.762,0,5,2.238,5,5V37z"/><path fill="#FFF" d="M12 19H17V36H12zM14.485 17h-.028C12.965 17 12 15.888 12 14.499 12 13.08 12.995 12 14.514 12c1.521 0 2.458 1.08 2.486 2.499C17 15.887 16.035 17 14.485 17zM36 36h-5v-9.099c0-2.198-1.225-3.698-3.192-3.698-1.501 0-2.313 1.012-2.707 1.99C24.957 25.543 25 26.511 25 27v9h-5V19h5v2.616C25.721 20.5 26.85 19 29.738 19c3.578 0 6.261 2.25 6.261 7.274L36 36 36 36z"/></svg></Link>
      <Link href="https://github.com/M-Faisal-Dev" target="_blank" >  
